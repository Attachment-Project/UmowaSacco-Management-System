...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM schedule_nai_macha WHERE matatu_numplate='$matatu_numplate' AND date='$date'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // insert a new record
        $query = "INSERT INTO schedule_nai_macha (matatu_numplate, date, dep1_t1, arrival1_t1, dep2_t1, arrival2_t1, dep1_t2, arrival1_t2, dep2_t2, arrival2_t2) VALUES ('$matatu_numplate', '$date', '$dep1_t1', '$arrival1_t1', '$dep2_t1', '$arrival2_t1', '$dep1_t2', '$arrival1_t2', '$dep2_t2', '$arrival2_t2')";
        mysqli_query($conn, $query);
