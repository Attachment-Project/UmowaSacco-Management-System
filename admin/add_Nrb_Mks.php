...
<html>
<head>
	<title>Route: Nairobi - Machakos</title>
	<style>
		body {
...
<body>
	<h1>Route: Nairobi - Machakos</h1>
	<form method="post" action="schedule_nai_macha.php">
		<label for="matatu_numplate">Matatu NumPlate:</label>
		<select name="matatu_numplate">
			<?php
			include('db.php');
			$query = "SELECT numplate FROM matatus WHERE RouteFrom='Nairobi' AND RouteTo='Machakos'";
